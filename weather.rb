...
def description_2(weather)
   puts "The weather in #{weather[:city]} is #{weather[:description]}. The temperature is #{weather[:temperature]} degrees Farenheit."
end
description_2(weather)
...
def farenheit (weather)
  weather[:temperature] - 32 == temp_2
